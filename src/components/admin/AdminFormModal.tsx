            ...
            <DialogPanel className="bg-white rounded-2xl w-full max-w-[640px] max-h-[85vh] overflow-hidden shadow-2xl flex flex-col">
              ...
              <div className="px-6 py-4 border-t border-gray-100 flex gap-3 justify-end shrink-0 bg-gray-50/50">
                ...
                <button
                  onClick={onSubmit}
                  disabled={loading}
                  className="px-5 py-2.5 text-sm text-white bg-[#04F87F] rounded-xl cursor-pointer border-none disabled:opacity-50 font-bold hover:bg-[#03d46d] transition-colors shadow-sm shadow-[#04F87F]/20"
                >
                  {loading ? (
