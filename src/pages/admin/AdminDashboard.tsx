...
const COLORS = ['#04F87F', '#6366f1', '#f59e0b', '#ef4444', '#3b82f6', '#a855f7', '#ec4899', '#14b8a6']
  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
        <BigCard icon="ti-users" label="전체 회원" value={data.totalUsers} sub={`오늘 +${data.newUsersToday}`} color="#04F87F" />
            ...
            <AreaChart data={data.signupTrend}>
              <defs>
                <linearGradient id="signupGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#04F87F" stopOpacity={0.3} />
                  <stop offset="100%" stopColor="#04F87F" stopOpacity={0} />
                </linearGradient>
              </defs>
              ...
              <Area type="monotone" dataKey="count" stroke="#04F87F" strokeWidth={2} fill="url(#signupGrad)" name="가입자" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
              ...
              {data.recentMembers.map((m, i) => (
                <div key={i} className="flex items-center justify-between">
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#04F87F] to-emerald-400 flex items-center justify-center shrink-0">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            <i className="ti ti-chart-dots text-lg text-[#04F87F]" />
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="text-xs text-[#04F87F] no-underline hover:underline flex items-center gap-1"
            >
        ...
        {!umamiOpen && (
          <button
            ...
            className="w-full py-3 bg-gray-50 border-none cursor-pointer text-sm text-gray-500 hover:text-[#04F87F] hover:bg-gray-100 transition-colors flex items-center justify-center gap-1.5"
          >
...
function RankRow({ rank, label, value, maxValue, currentValue }: {
  ...
  return (
    <div className="relative">
      <div className="absolute inset-0 bg-[#04F87F]/5 rounded-lg" style={{ width: `${(currentValue / maxValue) * 100}%` }} />
      <div className="relative flex items-center justify-between px-3 py-2">
        <div className="flex items-center gap-2.5 min-w-0">
          <span className={`text-xs font-bold w-5 text-center shrink-0 ${rank <= 3 ? 'text-[#04F87F]' : 'text-gray-400'}`}>{rank}</span>
