    ...
    <AdminLayout>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => setEditing({ title: '', scheduled_at: '', course_id: null, instructor_id: null })}
          className="bg-[#2ED573] text-white px-4 py-2 rounded-xl text-sm font-bold cursor-pointer border-none hover:bg-[#25B866] transition-colors shadow-sm shadow-[#2ED573]/20 flex items-center gap-1.5"><i className="ti ti-plus text-sm" /> 일정 추가</button>
      </div>
