          ...
          <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-5">
            {achievements.map((item) => (
              ...
              >
                ...
                <div className="p-5">
                  <span className="text-xs text-[#2ED573] font-medium">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <button
                      ...
                      className={`flex items-center gap-1.5 text-sm border-none bg-transparent cursor-pointer transition-colors ${likedIds.has(item.id) ? 'text-[#2ED573]' : 'text-gray-400 hover:text-[#2ED573]'}`}
                    >
                ...
                <div className="p-6">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-sm cursor-pointer transition-colors ${
                        likedIds.has(selectedAchievement.id)
                          ? 'border-[#2ED573] text-[#2ED573] bg-[#2ED573]/5'
                          : 'border-gray-200 text-gray-500 bg-white hover:border-[#2ED573]'
                      }`}
                    >
                  ...
                  {selectedAchievement.course && (
                    ...
                    >
                      ...
                      <span className="text-sm text-[#2ED573] font-bold flex items-center gap-1">
                  ...
                  <div className="flex gap-3 mt-4">
                    {user && selectedAchievement.user_id === user.id && (
                      <button
                        ...
                        className="flex-1 py-2.5 bg-[#2ED573] text-white rounded-xl text-sm font-bold cursor-pointer border-none hover:bg-[#25B866] transition-colors"
                      >
                        수정하기
                      </button>
                    )}
          ...
          <Dialog.Panel className="bg-white rounded-2xl max-w-lg w-full max-h-[85vh] overflow-y-auto shadow-xl p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                disabled={submitting}
                className="flex-1 py-2.5 bg-[#2ED573] text-white rounded-xl text-sm font-bold cursor-pointer border-none hover:bg-[#25B866] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
