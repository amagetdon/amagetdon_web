    ...
    <>
      ...
      <div className="max-w-[440px] mx-auto px-6 py-16">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {showResend && (
            <button
              ...
              className="text-sm text-[#04F87F] font-bold cursor-pointer bg-transparent border-none underline"
            >
              인증 메일 재발송
            </button>
          )}
          ...
          {resendMessage && (
            <p className={`text-sm ${resendMessage.includes('재발송') ? 'text-[#04F87F]' : 'text-red-400'}`}>
              {resendMessage}
            </p>
          )}
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          아직 회원이 아니신가요?{' '}
          <Link to="/signup" className="text-[#04F87F] font-bold no-underline">
            회원가입
          </Link>
        </div>
      </div>
        ...
        >
          <div className="bg-white rounded-2xl w-full max-w-[420px] overflow-hidden">
            ...
            <div className="p-6">
              ...
              {resetMessage && (
                <p className={`text-sm mb-4 ${resetMessage.includes('발송되었습니다') ? 'text-[#04F87F]' : 'text-red-400'}`}>
                  {resetMessage}
                </p>
              )}
              ...
              <button
                ...
                className="w-full bg-[#04F87F] text-white font-bold py-3 rounded-lg cursor-pointer border-none disabled:opacity-50"
              >
