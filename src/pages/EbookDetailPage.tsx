  ...
  const renderActionButton = () => {
    ...
    return (
      <button
        ...
        disabled={purchasing}
        className="w-full py-4 bg-[#04F87F] text-white font-bold text-center rounded-xl mt-6 cursor-pointer border-none disabled:opacity-50 disabled:cursor-not-allowed"
      >
